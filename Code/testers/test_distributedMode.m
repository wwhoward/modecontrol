% Run TimelyTrackingNetwork with distributed mode control
...
for n = 1:nRep
    ...
    FC = fusionCenter(tmpTargets, tmpTrackers, 'ModeControl', 'Distributed'); 
    
    for e = 1:nEpochs
        Targets = targetModel(10); 
        [Trackers, nTrackers, NodeLocations] = genTrackers(10);  
