    ...
    methods(Access=public)
        ...
        function [state, idx, tracks] = getState(obj, activityType)
            ...
            switch activityType
                ...
                case "active"
                    state = zeros(6, obj.nActiveTargets); 
                    j=1; 
                    for i = 1:obj.nTargets
                        if obj.Targets{i}.isActive
                ...
                case "retired"
                    state = zeros(6, obj.nRetiredTargets); 
                    j=1; 
                    for i = 1:obj.nTargets
                        if ~obj.Targets{i}.isActive
                            state(:,j) = obj.Targets{i}.state; 
    ...
    methods(Access=protected)
        ...
        function params = getTargetParams(obj, targetClass)
            ...
            switch targetClass
                ...
                case 1
                    params.signal = [0.5, 0, 0, 0.5]; % Probability of each signal type
                    ...
                    params.model_probs = [0.9 0.1 0]; % Probability of each motion model [const_v const_t const_a]
                    params.model_transition = [[0.9 0.1 0]; ...
                                               [0.5 0.5 0]; ...
                                               [0 0 1]]; % TODO fill in more realistic model
                
                % Class 2: UAV
                % Description: Can go any speed in any direction
                case 2
                    params.signal = [0, 1, 0, 0]; 
                    params.x_range = [[obj.minVals(1), obj.maxVals(1)]; ...
                                      [obj.minVals(1), obj.maxVals(2)]; ...
                    ...
                    params.model_probs = [0 1 0]; % Probability of each motion model [const_v const_t const_a]
                    params.model_transition = [[1 0 0]; ...
                                               [0 1 0]; ...
                                               [0 0 1]]; % TODO fill in more realistic model
                ...
                case 3
                    ...
                    params.model_probs = [0.5 0 0.5]; % Probability of each motion model [const_v const_t const_a]
                    params.model_transition = [[0.9 0 0.1]; ...
                                               [0   1 0]; ...
                                               [0.1 0 0.9]]; % TODO fill in more realistic model
